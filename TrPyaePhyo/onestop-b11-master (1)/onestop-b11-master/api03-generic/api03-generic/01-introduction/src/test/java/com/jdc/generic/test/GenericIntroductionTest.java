...
//		GenericUtil.addNumbers(stringList); // error because lower bound
	...
	void testForMethodBound() {
		String[] strArray = {"ABC", "ACBZE", "BAC", "CCA49", "CABbfjk" };
...
//		assertEquals(2, moyResult);
	...
	//	GenericUtil.countGreaterThan(tArray, null); // error bcuz thread is not type comparable
	}
	
	@Test
	@Order(4)
	void testForMultipleTypeParameter() {
...
//		var result = GenericUtil.<Integer, String> compare (isPair, vsPair);
